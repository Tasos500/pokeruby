...
const u8 BattleText_GainExpPoints[] = _("Το {STRING 0} έλαβε{STRING 1}\n{STRING 42} Πόντους ΕΜΠ.!\p");
const u8 BattleText_Terminator[] = _("");
const u8 BattleText_BoostedExp[] = _(" a boosted");
const u8 BattleText_GrewLevel[] = _("Το {STRING 0} ανέβηκε στο\nΕΠ. {STRING 1}!{UNKNOWN_A}\p");
const u8 BattleText_LearnedMove[] = _("Το {STRING 0} έμαθε\n{STRING 1}!{UNKNOWN_A}\p");
const u8 BattleText_TryingToLearnMove[] = _("Το {STRING 0} προσπαθεί\nνα μάθει {STRING 1}.\p");
const u8 BattleText_CantLearnMore[] = _("Όμως, το {STRING 0} δεν μπορεί να ξέρει\nπάνω από τέσσερις κινήσεις.\p");
const u8 BattleText_DeleteMove[] = _("Θα διαγράψεις κάποια κίνηση για να\nκάνεις χώρο για {STRING 1};");
const u8 BattleText_DeletedMove[] = _("Το {STRING 0} ξέχασε\n{STRING 1}.\p");
const u8 BattleText_StopLearning[] = _("{PAUSE 32}Να μην μάθει\n{STRING 1};");
const u8 BattleText_DidNotLearn[] = _("Το {STRING 0} δεν έμαθε\n{STRING 1}.\p");
const u8 BattleText_UseNext[] = _("Θα χρησιμοποιήσεις\nεπόμενο POKéMON;");
const u8 BattleText_AttackMissed[] = _("Η επίθεση του\n{ATTACKING_MON}αστόχησε!");
const u8 BattleText_ProtectedItself[] = _("Το {DEFENDING_MON}\nπροστάτευσε τον εαυτό του!");
const u8 BattleText_AvoidedDamage[] = _("Το {DEFENDING_MON} απέφυγε\nζημιά με {STRING 22}!");
const u8 BattleText_GroundMoveNegate[] = _("{DEFENDING_MON} makes GROUND\nmoves miss with {STRING 22}!");
const u8 BattleText_AvoidedAttack[] = _("Το {DEFENDING_MON} απέφυγε\nτην επίθεση!");
const u8 BattleText_DoesntAffect[] = _("Δεν επηρεάζει\nτο {DEFENDING_MON}...");
const u8 BattleText_AttackingFainted[] = _("Το {ATTACKING_MON}\nλιποθύμησε!\p");
const u8 BattleText_DefendingFainted[] = _("Το {DEFENDING_MON}\nλιποθύμησε!\p");
const u8 BattleText_WinningPrize[] = _("{STRING 50} {STRING 32} έλαβε ¥{STRING 0}\nως έπαθλο!\p");
const u8 BattleText_OutOfUsablePoke[] = _("{STRING 50} {STRING 32} δεν έχει\nάλλα POKéMON!\p");
const u8 BattleText_WhitedOut[] = _("{STRING 50} {STRING 32} έχασε τις αισθήσεις τ{PLAYER_GEN}!{PAUSE_UNTIL_PRESS}");
const u8 BattleText_PreventEscape[] = _("Το {STRING 16} αποτρέπει\nτη φυγή με {STRING 23}!\p");
const u8 BattleText_CantEscape[] = _("Δεν μπορείς να ξεφύγεις!\p");
const u8 BattleText_AttackingCantEscape[] = _("Το {ATTACKING_MON}\nδεν μπορεί να ξεφύγει!");
const u8 BattleText_HitMulti[] = _("Χτύπησε {STRING 0} φορά/ές!");
const u8 BattleText_FellAsleep[] = _("Το {STRING 14}\nαποκοιμήθηκε!");
const u8 BattleText_MadeAsleep[] = _("Το {STRING 23} του {STRING 16}\nέκανε το {STRING 14} να αποκοιμηθεί!");
const u8 BattleText_DefendingAsleep[] = _("Το {DEFENDING_MON}\nήδη κοιμάται!");
const u8 BattleText_AttackingAsleep[] = _("Το {ATTACKING_MON}\nήδη κοιμάται!");
const u8 BattleText_WasntAffected[] = _("Το {DEFENDING_MON}\nδεν επηρεάστηκε!");
const u8 BattleText_Poisoned[] = _("Το {STRING 14}\nδηλητηριάστηκε!");
const u8 BattleText_Poisoned2[] = _("Το {STRING 23} του {STRING 16}\nδηλητηρίασε το {STRING 14}!");
const u8 BattleText_PoisonHurt[] = _("Το {ATTACKING_MON} υποφέρει\nαπό το δηλητήριο!");
const u8 BattleText_AlreadyPoisoned[] = _("Το {DEFENDING_MON} είναι ήδη\nδηλητηριασμένο.");
const u8 BattleText_BadlyPoisoned[] = _("Το {STRING 14} δηλητηριάστηκε\nάσχημα!");
const u8 BattleText_EnergyDrained[] = _("Απορροφήθηκε η ενέργεια\nτου {DEFENDING_MON}!");
const u8 BattleText_Burned[] = _("Το {STRING 14} έπαθε έγκαυμα!");
const u8 BattleText_Burned2[] = _("Το {STRING 23} του {STRING 16}\nέκαψε το {STRING 14}!");
const u8 BattleText_BurnHurt[] = _("Το {ATTACKING_MON} υποφέρει\nαπό το έγκαυμα!");
const u8 BattleText_AlreadyBurned[] = _("Το {DEFENDING_MON} ήδη\nέχει έγκαυμα.");
const u8 BattleText_Frozen[] = _("Το{STRING 14}\nπάγωσε!");
const u8 BattleText_Frozen2[] = _("Το {STRING 23} του {STRING 16}\nπάγωσε το {STRING 14}!");
const u8 BattleText_FrozenSolid[] = _("Το {ATTACKING_MON}\nείναι παγωμένο!");
const u8 BattleText_DefendingDefrosted[] = _("Το {DEFENDING_MON}\nξεπάγωσε!");
const u8 BattleText_AttackingDefrosted[] = _("Το {ATTACKING_MON}\nξεπάγωσε!");
const u8 BattleText_Defrosted[] = _("Το {ATTACKING_MON}\nξεπάγωσε με το {STRING 17}!");
const u8 BattleText_Paralyzed[] = _("Το {STRING 14} είναι παραλυμένο!\nΊσως να μην μπορέσει να κινηθεί!");
const u8 BattleText_Paralyzed2[] = _("Το {STRING 23} του {STRING 16}\nπαρέλυσε το{STRING 14}!\lΊσως να μην μπορέσει να κινηθεί!");
const u8 BattleText_Paralyzed3[] = _("Το {ATTACKING_MON} είναι παραλυμένο!\nΔεν μπορεί να κινηθεί!");
const u8 BattleText_AlreadyParalyzed[] = _("Το {DEFENDING_MON}\nείναι ήδη παραλυμένο!");
const u8 BattleText_ParalysisHealed[] = _("Το {DEFENDING_MON}\nθεραπεύτηκε από την παράλυση!");
const u8 BattleText_DreamEaten[] = _("Το όνειρο του {DEFENDING_MON}\nφαγώθηκε!");
const u8 BattleText_AttackingStatNoHigher[] = _("Η {STRING 0} του {ATTACKING_MON}\nδεν πάει πιο πάνω!");
const u8 BattleText_DefendingStatNoHigher[] = _("Η {STRING 0} του {ATTACKING_MON}\nδεν πάει πιο κάτω!");
const u8 BattleText_StoppedWorking[] = _("Η {STRING 0} της ομάδας σου\nσταμάτησε να δουλεύει!");
const u8 BattleText_StoppedWorking2[] = _("Η {STRING 0} της αντίπαλης ομάδας\nσταμάτησε να δουλεύει!");
const u8 BattleText_Confused[] = _("Το {ATTACKING_MON}\nέχει συγχυστεί!");
const u8 BattleText_ConfusionSnapOut[] = _("Το {ATTACKING_MON} ηρέμησε\nαπό τη σύγχυση!");
const u8 BattleText_BecameConfused[] = _("Το {STRING 14}\nσυγχύστηκε!");
const u8 BattleText_AlreadyConfused[] = _("Το {DEFENDING_MON}\nείναι ήδη συγχυσμένο!");
const u8 BattleText_FellLove[] = _("Το {DEFENDING_MON}\nερωτεύτηκε!");
const u8 BattleText_InLoveWith[] = _("Το {ATTACKING_MON} είναι ερωτευμένο\nμε το {STRING 16}!");
const u8 BattleText_ImmobilizedBy[] = _("{ATTACKING_MON} is\nimmobilized by love!");
const u8 BattleText_BlownAway[] = _("{DEFENDING_MON} was\nblown away!");
const u8 BattleText_TypeTransform[] = _("Το {ATTACKING_MON} μεταμορφώθηκε\nσε τύπο {STRING 0}!");
const u8 BattleText_Flinched[] = _("Το {ATTACKING_MON} τινάχτηκε!");
const u8 BattleText_RegainedHealth[] = _("Το {DEFENDING_MON} ανέκτησε\nυγεία!");
const u8 BattleText_HPFull[] = _("Οι ΠΥ του {DEFENDING_MON}\nείναι πλήρεις!");
...
const u8 BattleText_EvadedAttack[] = _("Το {DEFENDING_MON} απέφυγε\nτην επίθεση!");
const u8 BattleText_HealthSapped[] = _("{ATTACKING_MON}'s health is\nsapped by LEECH SEED!");
const u8 BattleText_FastAsleep[] = _("Το {ATTACKING_MON}\nκοιμάται.");
const u8 BattleText_WokeUp[] = _("Το {ATTACKING_MON} ξύπνησε!");
...
const u8 BattleText_Critical[] = _("Κρίσιμο χτύπημα!");
const u8 BattleText_GrandSlam[] = _("Νοκ άουτ με ένα χτύπημα!");
const u8 BattleText_MoveForget123[] = _("{PAUSE 32}1, {PAUSE 15}2 και...{PAUSE 15} ...{PAUSE 15} ...{PAUSE 15}\n{PAUSE 15}{PLAY_SE SE_BALL_BOUNCE_1}Πουφ!\p");
const u8 BattleText_MoveForgetAnd[] = _("Και...\p");
const u8 BattleText_CantForgetHM[] = _("Οι κινήσεις ΜΜ δεν μπορούν\n να ξεχαστούν τώρα.\p");
const u8 BattleText_NotEffective[] = _("Δεν είχε μεγάλη επίδραση...");
const u8 BattleText_SuperEffective[] = _("Είχε εξαιρετική επίδραση!");
const u8 BattleText_GotAwaySafely[] = _("{PLAY_SE SE_FLEE}Ξέφυγες με ασφάλεια!\p");
const u8 BattleText_FledUsingItem[] = _("{PLAY_SE SE_FLEE}{ATTACKING_MON} ξέφυγε\nχρησιμοποιώντας το {STRING 19}!\p");
const u8 BattleText_FledUsingOther[] = _("{PLAY_SE SE_FLEE}{ATTACKING_MON} ξέφυγε\nχρησιμοποιώντας το {STRING 21}!\p");
const u8 BattleText_FledWild[] = _("{PLAY_SE SE_FLEE}Το άγριο {STRING 0} ξέφυγε!");
const u8 BattleText_PlayerDefeatedTrainer[] = _("Νίκησες τον\n{STRING 29}!");
const u8 BattleText_PlayerDefeatedTrainers[] = _("Νίκησες τον {STRING 30}\nκαι τον {STRING 29}!");
const u8 BattleText_PlayerLostTrainer[] = _("Έχασες ενάντια\nστον {STRING 29}!");
const u8 BattleText_PlayerLostTrainers[] = _("Έχασες ενάντια στον {STRING 30}\nκαι τον {STRING 29}!");
const u8 BattleText_PlayerTiedTrainer[] = _("Ισοφάρισες με\nτον{STRING 29}!");
const u8 BattleText_PlayerTiedTrainers[] = _("Ισοφάρισες με τον {STRING 30}\nκαι τον {STRING 29}!");
const u8 BattleText_FledSingle[] = _("{PLAY_SE SE_FLEE}{STRING 46} {STRING 29} ξέφυγε!");
const u8 BattleText_FledDouble[] = _("{PLAY_SE SE_FLEE}Οι {STRING 29} και\n{STRING 30} ξέφυγαν!");
...
const u8 BattleText_PlayerDefeatedTrainer2[] = _("Νίκησες {STRING 54}\n{STRING 25} {STRING 26}!\p");
...
const u8 BattleText_WildAppeared1[] = _("Ένα άγριο {STRING 3} εμφανίστηκε!\p");
const u8 BattleText_WildAppeared2[] = _("Ένα άγριο {STRING 3} εμφανίστηκε!\p");
const u8 BattleText_WildAppeared3[] = _("Ένα άγριο {STRING 3} εμφανίστηκε!{PAUSE 127}");
const u8 BattleText_WildDoubleAppeared[] = _("Άγρια {STRING 5} και\n{STRING 3} εμφανίστηκαν!\p");
const u8 BattleText_SingleWantToBattle1[] = _("{STRING 43} {STRING 25} {STRING 26}\nσε {STRING 52} σε μάχη!\p");
const u8 BattleText_SingleWantToBattle2[] = _("{STRING 46} {STRING 29}\nσε προκαλεί σε μάχη!");
const u8 BattleText_DoubleWantToBattle[] = _("Οι {STRING 29} {STRING 30}\nσε προκαλούν σε μάχη!");
...
const u8 BattleText_Wild[] = _("άγριο ");
const u8 BattleText_Foe[] = _("αντίπαλο ");
const u8 BattleText_Foe2[] = _("αντίπαλο ");
const u8 BattleText_Ally[] = _("φιλικό ");
const u8 BattleText_Foe3[] = _("αντίπαλο ");
const u8 BattleText_Ally2[] = _("φιλικό ");
const u8 BattleText_Foe4[] = _("αντίπαλο ");
const u8 BattleText_Ally3[] = _("φιλικό ");
const u8 BattleText_OpponentUsedMove[] = _("Το {ATTACKING_MON} χρησιμοποίησε\n{STRING 1}");
...
const u8 BattleText_Nominative_Female[] = _("Η");
const u8 BattleText_Nominative_Male[] = _("Ο");
const u8 BattleText_Nominative_Plural[] = _("Οι");
const u8 BattleText_Genitive_Female[] = _("της");
const u8 BattleText_Genitive_Male[] = _("του");
const u8 BattleText_Accusative_Female[] = _("τη");
const u8 BattleText_Accusative_Female_Ni[] = _("την");
const u8 BattleText_Accusative_Male[] = _("τον");
const u8 BattleText_Accusative_Plural[] = _("τους");
const u8 BattleText_Accusative_Plural_Female[] = _("τις");
const u8 BattleText_WantsToBattle_Singular[] = _("προκαλεί");
const u8 BattleText_WantsToBattle_Plural[] = _("προκαλούν");
