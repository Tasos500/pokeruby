...
extern const u8 gExpandedPlaceholder_Article_Male[];
extern const u8 gExpandedPlaceholder_Article_Male_Lower[];
extern const u8 gExpandedPlaceholder_Article_Female[];
extern const u8 gExpandedPlaceholder_Article_Female_Lower[];
extern const u8 gExpandedPlaceholder_Adjective_Male[];
extern const u8 gExpandedPlaceholder_Adjective_Female[];
extern const u8 gExpandedPlaceholder_Adjective_Male_Tonos[];
extern const u8 gExpandedPlaceholder_Adjective_Female_Tonos[];
extern const u8 gExpandedPlaceholder_Genitive_Male[];
extern const u8 gExpandedPlaceholder_Genitive_Female[];
extern const u8 gExpandedPlaceholder_Genitive_Male_Cap[];
extern const u8 gExpandedPlaceholder_Genitive_Female_Cap[];
extern const u8 gExpandedPlaceholder_Trainer_Male[];
extern const u8 gExpandedPlaceholder_Trainer_Female[];
extern const u8 gExpandedPlaceholder_Rival_Ending_Ni[];
extern const u8 gExpandedPlaceholder_Honey_Male[];
extern const u8 gExpandedPlaceholder_Honey_Female[];
extern const u8 gExpandedPlaceholder_Adjective_2_Female[];
extern const u8 gExpandedPlaceholder_Neighbor_Male[];
extern const u8 gExpandedPlaceholder_Neighbor_Female[];
extern const u8 gExpandedPlaceholder_One_Male[];
extern const u8 gExpandedPlaceholder_One_Female[];
